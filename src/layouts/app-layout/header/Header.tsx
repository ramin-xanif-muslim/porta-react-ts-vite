...
const Header = () => {
  return (
    <div className="grid w-full grid-cols-[0px_minmax(200px,_1fr)_auto] gap-4 bg-brand p-2 text-gray-400 md:grid-cols-[100px_minmax(200px,_1fr)_auto]">
      {/* left */}
      <div className="flex items-center">
        {/* logo */}
        <Link to="/" className="hidden ml-4 shrink-0 md:block">
          <img className="size-10" src="/logo.svg" alt="logo" />
        </Link>
      </div>
